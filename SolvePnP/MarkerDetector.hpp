...
public:
  ...
  void ChangeMarkerSize(float largeSize,float mediumSize,float smallSize);
...
private:
  ...
  std::vector<cv::Point3f> m_markerCorners3d,largeMarker3d,smallMarker3d,mediumMarker3d;//frontMarker3d,frontSmallMarker3d;
