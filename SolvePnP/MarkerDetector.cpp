...
void MarkerDetector::ChangeMarkerSize(float largeSize, float mediumSize, float smallSize) {
    //    m_markerCorners3d.clear();
    //    m_markerCorners3d.push_back(cv::Point3f(-size,-size,0));
    //    m_markerCorners3d.push_back(cv::Point3f(+size,-size,0));
    //    m_markerCorners3d.push_back(cv::Point3f(+size,+size,0));
    //    m_markerCorners3d.push_back(cv::Point3f(-size,+size,0));
    largeSize=largeSize/2;
    mediumSize=mediumSize/2;
    ...
    smallMarker3d.push_back(cv::Point3f(+smallSize, +smallSize, 0));
    smallMarker3d.push_back(cv::Point3f(-smallSize, +smallSize, 0));
    mediumMarker3d.clear();
    mediumMarker3d.push_back(cv::Point3f(-mediumSize, -mediumSize, 0));
    mediumMarker3d.push_back(cv::Point3f(+mediumSize, -mediumSize, 0));
    mediumMarker3d.push_back(cv::Point3f(+mediumSize, +mediumSize, 0));
    mediumMarker3d.push_back(cv::Point3f(-mediumSize, +mediumSize, 0));
//    frontMarker3d.clear();
...
//    frontMarker3d.push_back(cv::Point3f(+frontSize, +frontSize, 0));
//    frontMarker3d.push_back(cv::Point3f(-frontSize, +frontSize, 0));
//    frontSmallMarker3d.clear();
//    frontSmallMarker3d.push_back(cv::Point3f(-frontSmallSize, -frontSmallSize, 0));
//    frontSmallMarker3d.push_back(cv::Point3f(+frontSmallSize, -frontSmallSize, 0));
//    frontSmallMarker3d.push_back(cv::Point3f(+frontSmallSize, +frontSmallSize, 0));
//    frontSmallMarker3d.push_back(cv::Point3f(-frontSmallSize, +frontSmallSize, 0));
}
...
void MarkerDetector::estimatePosition(std::vector<Marker> &detectedMarkers) {
    ...
    for (size_t i = 0; i < detectedMarkers.size(); i++) {
        ...
        xPoint = xPoint / 4;
        yPoint = yPoint / 4;
        if(abs(xPoint-frameWidth/2)<abs(xPoints-frameWidth/2))
        {
            xPoints = xPoint;
        }
        if(abs(yPoint-frameHeight/2)<abs(yPoints-frameHeight/2))
        {
            yPoints = yPoint;
        }
        ...
        } /*else if ((m.id == 1)||(m.id == 3)||(m.id == 7)||(m.id == 9)) {
            cv::solvePnP(mediumMarker3d, m.points, camMatrix, distCoeff, raux, taux);
        }*/ /*else if ((m.id == 1)||(m.id == 4)||(m.id == 5)||(m.id == 6)||(m.id == 8))*/
        else if(m.id == 1)
        {
            cv::solvePnP(smallMarker3d, m.points, camMatrix, distCoeff, raux, taux);
        } /*else if (m.id == 4) {
            cv::solvePnP(frontSmallMarker3d, m.points, camMatrix, distCoeff, raux, taux);
        }*/
